...
This Privacy Policy explains how the Safari Keyboard Navigation Extension ("the Extension") handles your information. The Extension is designed with a local-first, privacy-respecting architecture. We do not collect, store, or transmit your personal data, browsing history, or keystrokes to any external servers.
