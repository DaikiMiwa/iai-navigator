...
- `docs/strategy/why-use-this-app.md`: このアプリが選ばれる理由の positioning メモ。
- `docs/strategy/paid-app-roadmap.md`: App Store の有料製品にするための roadmap。
- `docs/ja/strategy/paid-app-roadmap.md`: 有料アプリ化 roadmap の日本語訳。
