...
- `o` で browser navigation palette を開き、開いている tab、bookmark、recent history、ローカルで観測した page、extension command、direct URL、設定した search engine での web search を検索します。
