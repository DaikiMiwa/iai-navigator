...
- `Ctrl+f` / `Ctrl+b` で、input から focus を外さずに command palette の selection を 1 page 分上下へ移動できます。
...
- palette 内で `Ctrl+f` / `Ctrl+b` を押し、input に focus が残ったまま選択中の result が 1 page 分上下に移動することを確認する。
