...
- Palette prefix として `tab:`、`book:`、`history:`、`visit:`、`cmd:`、`url:`、`search:` を使うと検索対象や意図を絞れます。Search engine prefix の `g:`、`ddg:`、`br:`、`k:` で、その query だけ Google、DuckDuckGo、Brave Search、Kagi を明示できます。
